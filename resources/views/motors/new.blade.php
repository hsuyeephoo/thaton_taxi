@extends('layout.app')
@section('my_title') New Motor @stop
@section('content')
    <div class="card shadow">
        <div class="card-body">
            <h6> <i class="fas fa-plus-circle"></i> New Motor</h6>
            <hr>
                ...
                <div class="col-sm-6">
                    ...
                    <form enctype="multipart/form-data" method="post"  action="{{route('motor.new')}}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="driver_name" name="driver_name" class="form-control @if($errors->has('driver_name')) is-invalid  @endif">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input list="quarter_list" type="text" name="quarter" id="quarter" class="form-control @if($errors->has('quarter')) is-invalid  @endif ">
